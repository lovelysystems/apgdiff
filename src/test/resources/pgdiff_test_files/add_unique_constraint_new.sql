...
--
-- Name: inventoryitemsupplier_5a808b9c_key; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace:
--
...
--
-- Name: inventoryitemsupplier_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace:
--
