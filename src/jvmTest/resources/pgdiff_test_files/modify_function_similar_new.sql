...
--
-- Name: multiply_numbers(smallint, smallint); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.multiply_numbers(number1 smallint, number2 smallint) OWNER TO postgres;
